...
Reports and write-ups stay as Markdown in `docs/reports/`. Upload nothing to external services such as Postplan, gists or pastebins; the only allowed external write is a Wayback snapshot request.
